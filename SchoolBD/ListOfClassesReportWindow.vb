...
Public Class ListOfClassesReportWindow
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim baseQuery As String = "SELECT * FROM [Список классов]"
        Dim filterQuery As String = ""
        Dim sortQuery As String = ""

        ' Применить фильтр
        If Not String.IsNullOrEmpty(_appliedFilter) Then
            filterQuery = " WHERE Наименование = '" & _appliedFilter.Replace("'", "''") & "'"
        End If
        ...
        Try
            ...
            Using connection As New SqlConnection("Data Source=DESKTOP-NI2O2HU;Initial Catalog=School;Integrated Security=True")
                ...
                adapter.Fill(dataSet, "Список классов")

                ' Привязать данные к отчету
                Dim reportDataSource As New Microsoft.Reporting.WinForms.ReportDataSource("DataSet1", dataSet.Tables("Список классов"))
