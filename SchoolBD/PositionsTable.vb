Public Class PositionsTable
    Private Sub ДолжностиBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs)
        Me.Validate()
    ...
    Private Sub ДолжностиDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs)
    ...
    Private Sub ДолжностиDataGridView_CellContentClick_1(sender As Object, e As DataGridViewCellEventArgs) Handles ДолжностиDataGridView.CellContentClick
